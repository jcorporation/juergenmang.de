...
<div class="card mb-3 cardAbout">
  ...
  <div class="card-body">
    ...
    <ul>
      ...
      <li><a href="https://www.linkedin.com/in/juergen-mang/" rel="me"><span class="bi-linkedin me-2"></span>LinkedIn</a></li>
...
<div class="card mb-3 cardOpenSource">
  ...
  <div class="card-body">
    ...
    <div class="card-subsection">
      <h5>Restsh</h5>
      <p>Restsh is a shell environment to work with REST-API's on the command line. It is designed to be used interactively, in scripts or in CI/CD pipelines.</p>
      <ul>
        <li><a href="https://github.com/AxiansITSecurity/Restsh">Restsh</a></li>
      </ul>
    </div>
    <h3 class="card-title">MPD related</h3>
    <div class="card-subsection">
      ...
      <p><a href="https://github.com/jcorporation?tab=repositories">All projects</a>.</p>
...
<div class="card mb-3 cardPnP">
  ...
  <div class="card-body">
    ...
    <h3 class="card-title">SpacePirates</h3>
    ...
    <h3 class="card-title">Das Weltenbuch</h3>
